...
const typeDefs = `
  ...
  type Query {
    ...
    cars: [Car]
    car(id: String!): Car
    personWithCars(personId: String!): PersonAndCars
  }
  type Mutation {
...
const resolvers = {
  Query: {
    ...
    personWithCars: (root, args) => {
      ...
      //console.log(args.personId);
      const personCars = filter(cars, { personId: args.personId });
  ...
  Mutation: {
    ...
    updatePerson: (root, args) => {
      ...
      (person.firstName = args.firstName), (person.lastName = args.lastName);
      return person;
    },
    removePerson: (root, args) => {
      ...
      remove(people, { id: removedPerson.id });
      remove(cars, { personId: removedPerson.id });
